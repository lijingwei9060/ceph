...
// JFW: Calling this right now requires an explicit selection of this overload; so it can be done, but I wouldn't use it heavily
// until it's properly updated for Ranges.
